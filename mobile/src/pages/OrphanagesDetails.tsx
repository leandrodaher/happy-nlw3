...
export default function OrphanageDetails() {
  ...
  }, [params.id]); // se params.id mudar o api.get será executado novamente
  ...
  function handleOpenGoogleMapRoutes() {
    //orphanage.latitude o typescript indica erro porque useState<Orphanage>() é iniciado como vazio
    // ao utilizar "orphanage?.latitude" é com dizer ao typescript "se orphanage existe então usar propiedade latitude"
